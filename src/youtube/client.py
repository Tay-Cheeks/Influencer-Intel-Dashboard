...
if not YT_API_KEY:
    raise ValueError("YOUTUBE_API_KEY not found. Set it in Streamlit Cloud → App Settings → Secrets.")
...
def get_channel_stats(channel_input: str):
    ...
    try:
        ...
        return {
            ...
            "region": item["snippet"].get("country", "Global"),
...
def get_recent_videos(playlist_id: str, count: int = 8):
    ...
    try:
        ...
        # CRITICAL: enforce stable ordering
        video_data.sort(
